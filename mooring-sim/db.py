...
def seed(conn):
    ...
    scenario = {
        ...
        "ship": {
            ...
            "fairleads": [
                {"id": "f_bow", "name": "船首", "x": 86.0, "y": -10.0},
                {"id": "f_fore", "name": "前舷", "x": 45.0, "y": -14.0},
                {"id": "f_aft", "name": "后舷", "x": -45.0, "y": -14.0},
                {"id": "f_stern", "name": "船尾", "x": -86.0, "y": -10.0},
            ],
        },
        "bollards": [
            {"id": "b1", "name": "1#桩", "x": -120.0, "y": -28.0},
            {"id": "b2", "name": "2#桩", "x": -80.0, "y": -28.0},
            {"id": "b3", "name": "3#桩", "x": -40.0, "y": -28.0},
            {"id": "b4", "name": "4#桩", "x": 0.0, "y": -28.0},
            {"id": "b5", "name": "5#桩", "x": 40.0, "y": -28.0},
            {"id": "b6", "name": "6#桩", "x": 80.0, "y": -28.0},
            {"id": "b7", "name": "7#桩", "x": 120.0, "y": -28.0},
        ],
        "duration": 6.0,
        "dt": 0.2,
        "fenderK": 30000.0,
    ...
    plan_a = {
        ...
        "lines": [
            ...
            {"id": "l_b1", "name": "首横缆", "type": "breast",
             "fairleadId": "f_fore", "bollardId": "b4",
             "local": [45.0, -14.0],
             "length": L(45, -14, 0, -28), "k": 50000.0,
    ...
    plan_b = {
        ...
        "lines": [
            ...
            {"id": "l_b1", "name": "首横缆", "type": "breast",
             ...
             "safeLoad": 800.0, "pretension": 160.0, "autoLength": True,
             "active": True},
